...
/**
 * Basic sequence creator. Optionally will pass storage into the String based
 * storage engine when it detects it can work with compatible CompoundSet.
 *
...
public class DNASequenceCreator implements
    ...
    public boolean isSingleBased() {
        return compoundSet.getMaxSingleCompoundStringLength() == 1;
    }
